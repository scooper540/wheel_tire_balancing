    ...
    public partial class FiltersForm : Form
    {
       ...
       // private readonly MemoryStreamPlayer _player = new MemoryStreamPlayer();
        ...
        private void buttonAnalyzeFilter_Click(object sender, EventArgs e)
        {
            ...
            switch (filterTypesComboBox.Text)
            {
                ...
                case "BiQuad highshelf":
                    ...
                    break;
                case "One-pole LP":
                    _filter = new NWaves.Filters.OnePole.LowPassFilter(0.25);
                    break;
                case "One-pole HP":
                    _filter = new NWaves.Filters.OnePole.HighPassFilter(0.25);
                    break;
        ...
        private void AnalyzeBiQuadFilter(string filterType)
        {
            ...
            {
                case "BiQuad LP":
                    _filter = new NWaves.Filters.BiQuad.LowPassFilter(freq, q);
                    break;
                case "BiQuad HP":
                    _filter = new HighPassFilter(freq, q);
                    break;
                case "BiQuad BP":
                    _filter = new NWaves.Filters.BiQuad.BandPassFilter(freq, q);
                    break;
                case "BiQuad notch":
        ...
        private void AnalyzeButterworthFilter()
        {
            ...
            _filter = new NWaves.Filters.Butterworth.BandPassFilter(freq, 0.4, order);
        ...
        private void AnalyzeEllipticFilter()
        {
            ...
            _filter = new NWaves.Filters.Elliptic.LowPassFilter(freq, order, ripplePassDb, attenuateDb);
        ...
        private void AnalyzeChebyshevIFilter()
        {
            ...
            _filter = new NWaves.Filters.ChebyshevI.HighPassFilter(freq, order);
        ...
        private void AnalyzeChebyshevIIFilter()
        {
            ...
            _filter = new NWaves.Filters.ChebyshevII.BandStopFilter(freq, 0.4, order);
        ...
        private void AnalyzeBesselFilter()
        {
            ...
            _filter = new NWaves.Filters.Bessel.LowPassFilter(freq, order);
